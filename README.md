...
Пользователь вводит строку с выражением.
Создается объект StringCalculator, который инициализирует внутренние структуры.
2.2. Валидация выражения (validate)
...
Используется модифицированный алгоритм Дейкстры (shunting-yard):
